...
CREATE TABLE `game_state` (
	...
	`owned_upgrades` text DEFAULT '[]' NOT NULL,
	`achieved_milestones` text DEFAULT '[]' NOT NULL,
	`points_per_second` integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `game_state_user_id_unique` ON `game_state` (`user_id`);--> statement-breakpoint
CREATE INDEX `game_state_userId_idx` ON `game_state` (`user_id`);--> statement-breakpoint
CREATE TABLE `todo` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`text` text NOT NULL,
